...
public abstract class SellerApiService {
    ...
    public abstract Response updateSellerProject(String username,String projectId,ProjectPOJO body,SecurityContext securityContext) throws NotFoundException;
