...
public abstract class SellerApiService {
    public abstract Response addSellerProject(String username,Project body,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response updateSellerProject(String username,String projectId,Project body,SecurityContext securityContext) throws NotFoundException;
